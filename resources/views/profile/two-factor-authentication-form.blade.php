    ...
    <x-slot name="content">
        ...
        @if ($this->enabled)
            @if ($showingQrCode)
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                        {{ __('L\'authentification à deux facteurs est désormais activée.Analysez le code QR suivant à l\'aide de l\'application Authenticator de votre téléphone.') }}
                    </p>
                </div>
            ...
            @if ($showingRecoveryCodes)
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                        {{ __('Stockez ces codes de récupération dans un gestionnaire de mot de passe sécurisé.Ils peuvent être utilisés pour récupérer l\'accès à votre compte si votre appareil d\'authentification à deux facteurs est perdu.') }}
                    </p>
                </div>
